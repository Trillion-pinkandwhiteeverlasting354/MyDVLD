...
using static MyDVLD_Business.clsLicense;
...
namespace MyDVLD.Applications.Replace_Lost_Or_Damaged_License
{
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        {
            // This will decide which application type to use according to user selection.
        ...
        private void CtrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            // We don't allow the user to replace the license if it's  not Active.

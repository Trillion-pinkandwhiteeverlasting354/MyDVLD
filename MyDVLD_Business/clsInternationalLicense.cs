...
namespace MyDVLD_Business
{
    public class clsInternationalLicense : clsApplication
    {
        ...
        public static clsInternationalLicense Find(int InternationalLicenseID)
        {
            ...
            bool IsFound = clsInternationalLicenseData.GetInternationalLicenseInfoByID(InternationalLicenseID,
            ...
            if (IsFound)
            {
                ...
                return new clsInternationalLicense(App.ApplicationID, App.ApplicantPersonID,
                    App.ApplicationDate, App.ApplicationStatus, App.LastStatusDate,
                    App.PaidFees, App.CreatedByUserID, InternationalLicenseID, DriverID,

...
namespace MyDVLD_Business
{
    public class clsLocalDrivingLicenseApplication : clsApplication
    {
        ...
        {
            this.LocalDrivingLicenseApplicationID = clsLocalDrivingLicenseApplicationData.AddNewApplication
        ...
        public static clsLocalDrivingLicenseApplication FindByLocalDrivingAppLicenseID(int LocalDrivingLicenseApplicationID)
        {
            ...
            if (IsFound)
            {
                // First we need to get the base application 
        ...
        public bool Save()
        {
            // Step 1: Save the main application
            ...
            // Step 2: Save the local driving application (child table)
        ...
        {
            return clsLocalDrivingLicenseApplicationData.DeosPassTestType(LocalDrivingLicenseApplicationID, (int)TestTypeID);
        }

        public bool DoesPassTestType(clsTestType.enTestType TestTypeID)
        {
            return clsLocalDrivingLicenseApplicationData.DeosPassTestType(this.LocalDrivingLicenseApplicationID, (int)TestTypeID);
        }
        ...
        public int IssueLicenseForTheFirstTime(string Notes, int CreatedByUserID)
        {
            ...
            // Here, we check if the person have been a driver before.
            if (Driver == null)
            {
            ...
            // Now we have a driver there, so we can add new licesnse

...
namespace MyDVLD_Business
{
    public class clsTestAppointment
    {
        ...
        {
            this.TestAppointmentID = clsTestAppointmentData.AddNewTestAppointment((int)TestTypeID, this.LocalDrivingLicenseApplicationID,
        ...
        {
            return clsTestAppointmentData.UpdateTestAppointment(this.TestAppointmentID, (int)TestTypeID, this.LocalDrivingLicenseApplicationID,
